...
```
               Main Thread & Helpers                   Audio Thread
              ┌─────────────────────┐              ┌──────────────────┐
User ──────►  │  Main Event Loop    │────────────► │  Tracker         │
  keyboard    │                     │  (Play,      │                  │
  mouse       │  1. Parse text      │   Modify)    │  1. Drain cmds   │
  MIDI events │  2. Evaluate exprs  │              │  2. Promote      │
              │  3. Optimize &      │              │     pending →    │
              │     precompute      │              │     active       │
